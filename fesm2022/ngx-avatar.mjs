...
class SourceFactory {
    ...
    static { this.ɵfac = function SourceFactory_Factory(t) { return new (t || SourceFactory)(); }; }
    static { this.ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: SourceFactory, factory: SourceFactory.ɵfac }); }
}
...
class AvatarService {
    ...
    static { this.ɵfac = function AvatarService_Factory(t) { return new (t || AvatarService)(i0.ɵɵinject(i1.HttpClient), i0.ɵɵinject(AvatarConfigService)); }; }
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(AvatarService, [{
        type: Injectable
    }], () => [{ type: i1.HttpClient }, { type: AvatarConfigService }], null); })();
...
class AvatarComponent {
    ...
    static { this.ɵfac = function AvatarComponent_Factory(t) { return new (t || AvatarComponent)(i0.ɵɵdirectiveInject(SourceFactory), i0.ɵɵdirectiveInject(AvatarService)); }; }
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(AvatarComponent, [{
  ...
  `, styles: [":host{border-radius:50%}\n"] }]
    }], () => [{ type: SourceFactory }, { type: AvatarService }], { round: [{
            type: Input
        }], size: [{
            type: Input
        }], textSizeRatio: [{
...
export { AvatarComponent, AvatarModule, AvatarService, AvatarSource, SourceFactory, defaultColors, defaultSources };
